...
export default function CareerHero() {
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden bg-[#14532d] text-white">
      <img src="/career-banner.jpg" alt="Reliaf Agrotech team and farming innovation" className="absolute inset-0 h-full w-full object-cover" />
      ...
      <div className="relative mx-auto w-full max-w-7xl px-6 py-28 lg:px-8">
        <div className="max-w-3xl" data-aos="fade-up">
          ...
          <a href="#apply" className="mt-9 inline-flex items-center gap-3 rounded-xl bg-[#facc15] px-7 py-4 font-bold text-[#14532d] shadow-lg transition hover:scale-105 hover:bg-yellow-300">Explore opportunities <FaArrowRight /></a>
        </div>
      </div>
