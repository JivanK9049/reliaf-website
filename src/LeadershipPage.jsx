...
<p className="text-green-700 font-semibold text-center mt-4">
  Driving Innovation, Sustainability & Farmer Success
</p>
</h1>
...
<div className="bg-white rounded-3xl shadow-lg p-8 mb-16">
  ...
  <p className="text-gray-700 leading-8">
    To become India's most trusted agricultural solutions company by empowering
    farmers through innovative, sustainable and science-based agricultural technologies.
  </p>
</div>
...
<section className="py-16 text-center bg-white rounded-3xl shadow-xl mx-6 mb-10">
  <h2 className="text-3xl font-bold text-green-700 mb-4">
    Connect With Our Leadership Team
  </h2>

  <p className="text-gray-600 mb-6">
    We are committed to supporting farmers, distributors and partners.
  </p>
