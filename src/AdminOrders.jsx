...
export default function AdminOrders() {
  ...
  const deleteRecord = async (type, id, label) => {
    ...
    const table = type === "order" ? "orders" : type === "demo" ? "farmer_demos" : type === "coupon" ? "lucky_draw_coupons" : "dealership_applications";
